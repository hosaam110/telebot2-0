...
def create_keyboard_for_question(question_number):
    ...
    elif question_number == 6 and question_valid_6:  # Last question
        return create_yes_no_keyboard_6()
    else:
...
def handle_messages(original_message):
    ...
    if current_question < len(questions):
        ...
        current_question = 0  # إعادة تعيين قيمة current_question للاستبيان التالي
